...
const CONTACT_EMAIL = "privacy@dmprod.app"; // [PLACEHOLDER] replace with a real inbox you control
  ...
  return (
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-8 px-6 py-16">
      ...
      <Section title="Overview">
        <p>
          DMProd (&ldquo;we&rdquo;, &ldquo;us&rdquo;) is a service that lets
          you share Instagram reels with our bot account and turns them into
          structured tasks — pushed to destinations like Notion, Google
      ...
      <Section title="Information we collect">
        <List
          items={[
            [
              "Account information",
              "The email address and password (stored as a salted hash, never in plain text) you use to sign up for the DMProd dashboard.",
            ],
            [
              "Instagram account information",
              "When you connect your Instagram account, we store your Instagram user ID and username so we can match reels you send our bot to your DMProd account. We do not store your Instagram password — connection happens through Instagram's own login flow.",
            ],
            [
              "Content you send us",
      ...
      <Section title="How we use your information">
        <p>
          We use the information above solely to operate DMProd: to identify
          you, to process reels you send us into structured tasks, and to
          deliver those tasks to the destinations you choose. We do not sell
          your information, and we do not use your content to train any
          models — reels you share are processed through Google&apos;s Gemini
          API under your own API key and Google&apos;s own terms.
        </p>
      </Section>
      ...
      <Section title="Data security">
        <p>
          ...
          data is limited to what DMProd&apos;s own systems need to operate the
          service.
        </p>
      </Section>
